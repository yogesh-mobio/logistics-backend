    ...
    (ChartJs.prototype.init = function () {
      ...
      var pieChart = {
        ...
        datasets: [
          {
            data: [300, 180, 210],
            backgroundColor: ["#f06292", "#4ac18e", "#ebeff2"],
            hoverBackgroundColor: ["#f06292", "#4ac18e", "#ebeff2"],
      ...
      //donut chart
      var donutChart = {
        labels: ["Desktops", "Tablets", "Deactivated"],
        datasets: [
          {
            data: [300, 210, 120],
            backgroundColor: ["#67a8e4", "#8d6e63", "#ebeff2"],
            hoverBackgroundColor: ["#67a8e4", "#8d6e63", "#ebeff2"],
            hoverBorderColor: "#fff",
          },
        ],
      };
      ...
      var polarChart = {
        datasets: [
          {
            data: [11, 16, 7, 18],
            backgroundColor: ["#67a8e4", "#8d6e63", "#ebeff2", "#f5b7b7"],
